...
- 裁判声音：**女声 / 男声** 可选（按性别+音质自动挑选系统最佳人声）；**赛前或比赛中都能随时切换**
- 队名：赛前可输入双方队名（记住上次输入）；播报时**按内容自动选中/英文人声**——即便英文播报模式，中文队名也能正确读出
- 设计：简约高级 dark 风（草地绿 + 网球黄绿 + 奶白），网球图标用系统 SF Symbol `tennisball.fill`

...
- 语言：中文 / English 可切换（记住上次选择）
- 主题：**温网（草地）/ 法网（红土）/ 美网（硬地）** 三大满贯场地主题，球场线背景
- 队名：赛前可输入双方队名（记住上次输入）
...
- 追踪发球方：**报分只报数字、发球方分数永远在前**（专业裁判风格：中文「四十比三十」「十五平」，英文 "forty thirty" / "fifteen all"，0 读 love / 零）；单数局结束提醒「换边」，并提示「该谁发球」；队名只出现在「拿下这一局 / 该谁发球 / 胜盘」播报中。
